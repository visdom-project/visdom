...
| [roadmapper-microfronted-heatmap](https://github.com/PatricKangasmaki/roadmapper-heatmap-microfront) | Roadmapper Heatmap Micro Frontend | This demo shows how the Roadmapper tool's heatmap visualization could be implemented as a micro frontend. | Vincit |
| [roadmapper-microfronted-planner](https://github.com/PatricKangasmaki/roadmapper-planner-microfront) | Roadmapper Planner Micro Frontend | This demo shows how the Roadmapper tool's planner visualization could be implemented as a micro frontend. | Vincit |
