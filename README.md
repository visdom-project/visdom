...
| [visdom-educational-dashboard](https://github.com/visdom-project/VISDOM-educational-dashboard/tree/master) | VISDOM educational dashboard | The VISDOM educational dashboard demonstrates the teaching use case of the VISDOM project by providing several different visualizations for exercise data originating from A+ LMS and GitLab CMS. Micro frontend versions of the visualizations used in the dashboard are provided in the VISDOM Micro Frontends repository. | Tampere University |
| [visdom-project-data-dashboard](https://github.com/visdom-project/VISDOM-project-data-dashboard) | VISDOM project data dashboard | A dashboard containing EKG visualization that can be used to visualize open-source project data. This dashboard is based on the VISDOM educational dashboard. | Tampere University |
| [visdom-micro-frontends](https://github.com/visdom-project/VISDOM-micro-frontends)               | VISDOM Micro Frontends        | The Micro Frontends demonstrate the teaching use case of the VISDOM Project by visualizing exercise data originating from A+ LMS and GitLab CMS. Includes also the VISDOM Roadmapper tool's heatmap and planner visualizations implemented as micro frontends.                                                                                                          | Tampere University and Vincit |
...
| [visdom-satd-management-system](https://github.com/yikun-li/visdom-satd-management-system.git)   | VISDOM SATD management system | The VISDOM SATD management system provides support for self-admitted technical debt (SATD) visualization and management. This system is able to identify SATD from code comments and issue tracking systems. It currently supported two data sources which are GitHub and Jira issue tracking system.                                                                   | University of Groningen       |
